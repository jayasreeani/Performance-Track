...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleLocalLogin(e) {
        ...
        if (password === 'delivery123') {
            ...
            elements.loginLoaderTitle.textContent = "Verifying Local Access Rights...";
            ...
            showNotification("Authorized local manager session.", "success");
            initApp();
        } else {
            showNotification("Invalid credentials. Please verify your manager token.", "error");
        }
    }
    ...
    function loadSettingsDisplay() {
        ...
        elements.managerNameDisplay.textContent = settings.managerName || 'User';
        elements.managerRoleDisplay.textContent = settings.managerRole || 'Delivery Manager';
        elements.evaluatorNameInput.value = settings.managerName || '';
